...
parser.add_argument('--ants_path', type=str, default='/home/brats/antsbin/bin/',
                   help='path where the ants is installed, typically /home/user/antsbin/bin/')
parser.add_argument('--input_path', type=str ,default='/media/brats/MyPassport/Avinash/Kaminstas_2018/MICCAI_BraTS_2018_Data_Training/LGG',
