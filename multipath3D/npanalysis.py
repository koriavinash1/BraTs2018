...
if __name__ == '__main__':
    path = '/media/brats/MyPassport/Avinash/Kaminstas_2018/MICCAI_BraTS_2018_Data_Training/test'
    predict_prefix = 'postProcessed_2D_tiramisu.nii.gz'
    out_path = '/media/brats/MyPassport/Avinash/Tiramisu_2D/performance_csvs/'
    file_name = 'Tiramisu_2D_Post_Processing.csv'
